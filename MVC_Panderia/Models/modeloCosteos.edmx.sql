...
-- --------------------------------------------------
-- Date Created: 06/01/2018 09:54:24
-- Generated from EDMX file: C:\Users\genova\Documents\GitHub\costeo\MVC_Panderia\Models\modeloCosteos.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[precio_venta]', 'U') IS NOT NULL
    DROP TABLE [dbo].[precio_venta];
GO
